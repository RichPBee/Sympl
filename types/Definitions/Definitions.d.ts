...
export interface IRenderer {
    ...
    appendSections(parent: IBaseComponent | IView, child: IBaseComponent | Array<IBaseComponent>): any;
    clearSection(section: IBaseComponent): any;
    removeElement(element: IBaseComponent): any;
    updateSection(parent: IBaseComponent, child: IBaseComponent): any;
}
